...
public:
	...
	virtual bool toString(std::string& s) const { glv::toToken(s, &Base::values()[0], size()); return true; }
...
public:
	...
	virtual bool toString(std::string& v) const { glv::toToken(v, value()); return true; }
	virtual bool fromString(const std::string& v){
		float r; if(glv::fromToken(r,v)){ value(r);	return true; } return false;
	}
};
